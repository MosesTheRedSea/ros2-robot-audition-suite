...
audition_msgs__srv__ProceedToNext_Request__init(audition_msgs__srv__ProceedToNext_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->operator_note)) {
    audition_msgs__srv__ProceedToNext_Request__fini(msg);
    return false;
  }
  return true;
}
...
audition_msgs__srv__ProceedToNext_Request__create()
{
  ...
  audition_msgs__srv__ProceedToNext_Request * msg = (audition_msgs__srv__ProceedToNext_Request *)allocator.allocate(sizeof(audition_msgs__srv__ProceedToNext_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(audition_msgs__srv__ProceedToNext_Request));
  bool success = audition_msgs__srv__ProceedToNext_Request__init(msg);
  if (!success) {
...
audition_msgs__srv__ProceedToNext_Request__Sequence__init(audition_msgs__srv__ProceedToNext_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  audition_msgs__srv__ProceedToNext_Request * data = NULL;

  if (size) {
    data = (audition_msgs__srv__ProceedToNext_Request *)allocator.zero_allocate(size, sizeof(audition_msgs__srv__ProceedToNext_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = audition_msgs__srv__ProceedToNext_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        audition_msgs__srv__ProceedToNext_Request__fini(&data[i - 1]);
      }
...
audition_msgs__srv__ProceedToNext_Request__Sequence__fini(audition_msgs__srv__ProceedToNext_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      audition_msgs__srv__ProceedToNext_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  audition_msgs__srv__ProceedToNext_Request__Sequence * array = (audition_msgs__srv__ProceedToNext_Request__Sequence *)allocator.allocate(sizeof(audition_msgs__srv__ProceedToNext_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = audition_msgs__srv__ProceedToNext_Request__Sequence__init(array, size);
  if (!success) {
...
audition_msgs__srv__ProceedToNext_Request__Sequence__destroy(audition_msgs__srv__ProceedToNext_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    audition_msgs__srv__ProceedToNext_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
audition_msgs__srv__ProceedToNext_Request__Sequence__are_equal(const audition_msgs__srv__ProceedToNext_Request__Sequence * lhs, const audition_msgs__srv__ProceedToNext_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!audition_msgs__srv__ProceedToNext_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  audition_msgs__srv__ProceedToNext_Request__Sequence * output)
{
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!audition_msgs__srv__ProceedToNext_Request__copy(
...
audition_msgs__srv__ProceedToNext_Response__init(audition_msgs__srv__ProceedToNext_Response * msg)
{
  ...
  // accepted
  // next_waypoint_label
  if (!rosidl_runtime_c__String__init(&msg->next_waypoint_label)) {
    audition_msgs__srv__ProceedToNext_Response__fini(msg);
    return false;
  }
  return true;
}
...
audition_msgs__srv__ProceedToNext_Response__fini(audition_msgs__srv__ProceedToNext_Response * msg)
{
  ...
  // accepted
  // next_waypoint_label
  rosidl_runtime_c__String__fini(&msg->next_waypoint_label);
}
...
audition_msgs__srv__ProceedToNext_Response__are_equal(const audition_msgs__srv__ProceedToNext_Response * lhs, const audition_msgs__srv__ProceedToNext_Response * rhs)
{
  ...
  // next_waypoint_label
  if (!rosidl_runtime_c__String__are_equal(
      &(lhs->next_waypoint_label), &(rhs->next_waypoint_label)))
  {
    return false;
  }
  return true;
  ...
  audition_msgs__srv__ProceedToNext_Response * output)
{
  ...
  // next_waypoint_label
  if (!rosidl_runtime_c__String__copy(
      &(input->next_waypoint_label), &(output->next_waypoint_label)))
  {
    return false;
  }
  return true;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  audition_msgs__srv__ProceedToNext_Response * msg = (audition_msgs__srv__ProceedToNext_Response *)allocator.allocate(sizeof(audition_msgs__srv__ProceedToNext_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(audition_msgs__srv__ProceedToNext_Response));
  bool success = audition_msgs__srv__ProceedToNext_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
audition_msgs__srv__ProceedToNext_Response__Sequence__init(audition_msgs__srv__ProceedToNext_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  audition_msgs__srv__ProceedToNext_Response * data = NULL;

  if (size) {
    data = (audition_msgs__srv__ProceedToNext_Response *)allocator.zero_allocate(size, sizeof(audition_msgs__srv__ProceedToNext_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = audition_msgs__srv__ProceedToNext_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        audition_msgs__srv__ProceedToNext_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
audition_msgs__srv__ProceedToNext_Response__Sequence__fini(audition_msgs__srv__ProceedToNext_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      audition_msgs__srv__ProceedToNext_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  audition_msgs__srv__ProceedToNext_Response__Sequence * array = (audition_msgs__srv__ProceedToNext_Response__Sequence *)allocator.allocate(sizeof(audition_msgs__srv__ProceedToNext_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = audition_msgs__srv__ProceedToNext_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
audition_msgs__srv__ProceedToNext_Response__Sequence__destroy(audition_msgs__srv__ProceedToNext_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    audition_msgs__srv__ProceedToNext_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
audition_msgs__srv__ProceedToNext_Response__Sequence__are_equal(const audition_msgs__srv__ProceedToNext_Response__Sequence * lhs, const audition_msgs__srv__ProceedToNext_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!audition_msgs__srv__ProceedToNext_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  audition_msgs__srv__ProceedToNext_Response__Sequence * output)
{
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!audition_msgs__srv__ProceedToNext_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
