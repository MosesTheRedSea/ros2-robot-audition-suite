...
#ifndef AUDITION_MSGS__SRV__DETAIL__ABORT_SESSION__FUNCTIONS_H_
#define AUDITION_MSGS__SRV__DETAIL__ABORT_SESSION__FUNCTIONS_H_
...
/// Initialize srv/AbortSession message.
/**
...
/// Finalize srv/AbortSession message.
/**
...
/// Create srv/AbortSession message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * audition_msgs__srv__AbortSession_Request__init().
...
/// Destroy srv/AbortSession message.
/**
 * It calls
 * audition_msgs__srv__AbortSession_Request__fini()
...
/// Check for srv/AbortSession message equality.
/**
...
/// Copy a srv/AbortSession message.
/**
...
/// Initialize array of srv/AbortSession messages.
/**
...
/// Finalize array of srv/AbortSession messages.
/**
 * It calls
 * audition_msgs__srv__AbortSession_Request__fini()
...
/// Create array of srv/AbortSession messages.
/**
 * It allocates the memory for the array and calls
 * audition_msgs__srv__AbortSession_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/AbortSession messages.
/**
 * It calls
 * audition_msgs__srv__AbortSession_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/AbortSession message array equality.
/**
...
/// Copy an array of srv/AbortSession messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * audition_msgs__srv__AbortSession_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_audition_msgs
...
/**
 * It calls
 * audition_msgs__srv__AbortSession_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_audition_msgs
...
/**
 * It allocates the memory for the array and calls
 * audition_msgs__srv__AbortSession_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_audition_msgs
...
/**
 * It calls
 * audition_msgs__srv__AbortSession_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AUDITION_MSGS__SRV__DETAIL__ABORT_SESSION__FUNCTIONS_H_
