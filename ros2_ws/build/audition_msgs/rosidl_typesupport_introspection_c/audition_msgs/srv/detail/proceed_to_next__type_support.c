...
void ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_init_function(
...
void ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_fini_function(void * message_memory)
{
  audition_msgs__srv__ProceedToNext_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_message_member_array[2] = {
  {
    "proceed",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_message_members = {
  "audition_msgs__srv",  // message namespace
  "ProceedToNext_Request",  // message name
  2,  // number of fields
  sizeof(audition_msgs__srv__ProceedToNext_Request),
  ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_message_member_array,  // message members
  ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_message_type_support_handle = {
  0,
  &ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, audition_msgs, srv, ProceedToNext_Request)() {
  if (!ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_message_type_support_handle.typesupport_identifier) {
    ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ProceedToNext_Request__rosidl_typesupport_introspection_c__ProceedToNext_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_fini_function(void * message_memory)
{
  audition_msgs__srv__ProceedToNext_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_message_member_array[2] = {
  {
    "accepted",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_BOOLEAN,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_message_members = {
  "audition_msgs__srv",  // message namespace
  "ProceedToNext_Response",  // message name
  2,  // number of fields
  sizeof(audition_msgs__srv__ProceedToNext_Response),
  ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_message_member_array,  // message members
  ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_message_type_support_handle = {
  0,
  &ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, audition_msgs, srv, ProceedToNext_Response)() {
  if (!ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_message_type_support_handle.typesupport_identifier) {
    ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &ProceedToNext_Response__rosidl_typesupport_introspection_c__ProceedToNext_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
