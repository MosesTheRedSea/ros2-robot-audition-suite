...
bool audition_msgs__msg__collection_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("audition_msgs.msg._collection_status.CollectionStatus", full_classname_dest, 53) == 0);
  }
  audition_msgs__msg__CollectionStatus * ros_message = _ros_message;
  {  // header
  ...
  {  // current_waypoint_id
    ...
    ros_message->current_waypoint_id = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // current_waypoint_label
    PyObject * field = PyObject_GetAttrString(_pymsg, "current_waypoint_label");
    if (!field) {
      return false;
    }
    ...
    rosidl_runtime_c__String__assign(&ros_message->current_waypoint_label, PyBytes_AS_STRING(encoded_field));
...
{
  /* NOTE(esteve): Call constructor of CollectionStatus */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("audition_msgs.msg._collection_status");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CollectionStatus");
  ...
  {  // current_waypoint_id
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->current_waypoint_id);
    {
  ...
  {  // current_waypoint_label
    ...
    field = PyUnicode_DecodeUTF8(
      ros_message->current_waypoint_label.data,
      strlen(ros_message->current_waypoint_label.data),
      "replace");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "current_waypoint_label", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
