...
public:
  ...
  {
    record_trigger_pub = create_publisher<std_msgs::msg::Bool>(
      "/record_trigger", 10);

    status_pub = create_publisher<audition_msgs::msg::CollectionStatus>(
      "/collection_status", 10);

    proceed_pub = create_publisher<std_msgs::msg::Bool>(
      "/proceed_command", 10);

    waypoint_sub = create_subscription<audition_msgs::msg::CollectionStatus>(
      "/current_waypoint", 10,
      std::bind(&CollectionNode::waypointCallback, this, std::placeholders::_1));

    proceed_sub = create_subscription<std_msgs::msg::Bool>(
      "/proceed_command", 10,
      std::bind(&CollectionNode::proceedCallback, this, std::placeholders::_1));
