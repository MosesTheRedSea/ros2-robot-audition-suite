...
static const _CollectionStatus_type_support_symbol_names_t _CollectionStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, audition_msgs, msg, CollectionStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, audition_msgs, msg, CollectionStatus)),
  }
};
...
{
  return &::audition_msgs::msg::rosidl_typesupport_cpp::CollectionStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, audition_msgs, msg, CollectionStatus)() {
  return get_message_type_support_handle<audition_msgs::msg::CollectionStatus>();
}
